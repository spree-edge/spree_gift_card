...
if Spree::Product.gift_cards.count.zero?
  puts "\tCreating default gift card..."
  shipping_category = Spree::ShippingCategory.create(name: 'Gift Card')
  product = Spree::Product.new(available_on: Time.now, name: 'Gift Card', is_gift_card: true, slug: 'gift-card',
                               price: 0, shipping_category_id: shipping_category.id)
